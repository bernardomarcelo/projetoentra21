...
<body>
    ...
    <form method="post" action="${pageContext.request.contextPath}/depoimento">
        <label for="avaliacaoId">ID da Avaliação:</label><br />
        <input type="text" id="avaliacaoId" name="avaliacaoId" value="1" required /><br /><br />
        
         <label for="avaliacaoId">ID do Usuario:</label><br />
        <input type="text" id="usuarioId" name="usuarioId" value="1" required /><br /><br />
